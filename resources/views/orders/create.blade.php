            ...
            <div class="row g-4 mb-4">
                @forelse ($products as $product)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="order-create-product-card h-100">
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <input type="number" min="0" max="{{ $product->stock }}" name="qty[{{ $product->id }}]" id="qty_{{ $product->id }}" class="order-create-qty-input" value="{{ old('qty.'.$product->id, 0) }}">
                                </div>
                            </div>
                        </div>
                    </div>
